(function (global, factory) {
  ...
  var css = "/* http://meyerweb.com/eric/tools/css/reset/ \r\n   v2.0 | 20110126\r\n   License: none (public domain)\r\n*/\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline;\n}\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n  display: block;\n}\n\nbody {\n  line-height: 1;\n}\n\nol, ul {\n  list-style: none;\n}\n\nblockquote, q {\n  quotes: none;\n}\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: \"\";\n  content: none;\n}\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0;\n}\n\n#searchResult {\n  display: none;\n}\n\n/* common style */\n* {\n  box-sizing: border-box;\n}\n\na {\n  text-decoration: none;\n}\n\nhtml,\nhtml body {\n  height: 100%;\n  width: 100%;\n  position: relative;\n  font-size: 16px;\n}\n\nb {\n  padding: 0 6px;\n}\n\n.globe,\n.panel {\n  height: 100%;\n  width: auto;\n  display: flex;\n  position: relative;\n  flex-direction: column;\n  /* input-hook */\n  /* grid hook*/\n  /* btn style*/\n  /* Input */\n  /* form */\n  /* grid system */\n  /* textarea */\n}\n.globe > .body,\n.panel > .body {\n  padding: 8px 8px;\n  overflow-y: auto;\n  overflow-x: hidden;\n  flex: 1;\n}\n.globe > .foot,\n.panel > .foot {\n  padding: 0 8px;\n}\n.globe > .head,\n.panel > .head {\n  border-bottom: solid #f4f4f4 10px !important;\n  padding: 0 8px;\n}\n.globe.with_sider,\n.panel.with_sider {\n  margin-left: 240px;\n}\n.globe > .sider,\n.panel > .sider {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: -240px;\n  width: 240px;\n  background-color: #eff5fa;\n  border-right: 1px solid #aab6d0;\n}\n.globe.with_sider_right,\n.panel.with_sider_right {\n  margin-right: 320px;\n}\n.globe > .sider_right,\n.panel > .sider_right {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  right: -320px;\n  width: 320px;\n  background-color: #eff5fa;\n  border-left: 1px solid #aab6d0;\n}\n.globe .mini-widget, .globe body, .globe .mini-button, .globe .mini-menuitem, .globe .mini-layout-region-header, .globe .mini-panel-header, .globe .mini-outlookbar-groupHeader, .globe .mini-grid-headerCell, .globe .mini-grid-cell, .globe .mini-grid-columnproxy, .globe .mini-listbox td, .globe .mini-calendar, .globe .mini-calendar-button, .globe .mini-tabs, .globe .mini-tree, .globe .mini-textbox-input, .globe .mini-buttonedit-input, .globe .mini-textboxlist-input, .globe .mini-textboxlist, .globe .mini-pager, .globe .mini-checkboxlist table label, .globe .mini-radiobuttonlist table label, .globe .mini-checkbox, .globe .mini-checkboxlist, .globe .mini-radiobuttonlist, .globe .mini-radiobuttonlist label, .globe .mini-layout, .globe .mini-calendar, .globe .mini-calendar-menu-month, .globe mini-calendar-date, .globe mini-calendar-menu-year, .globe .mini-calendar-title,\n.panel .mini-widget,\n.panel body,\n.panel .mini-button,\n.panel .mini-menuitem,\n.panel .mini-layout-region-header,\n.panel .mini-panel-header,\n.panel .mini-outlookbar-groupHeader,\n.panel .mini-grid-headerCell,\n.panel .mini-grid-cell,\n.panel .mini-grid-columnproxy,\n.panel .mini-listbox td,\n.panel .mini-calendar,\n.panel .mini-calendar-button,\n.panel .mini-tabs,\n.panel .mini-tree,\n.panel .mini-textbox-input,\n.panel .mini-buttonedit-input,\n.panel .mini-textboxlist-input,\n.panel .mini-textboxlist,\n.panel .mini-pager,\n.panel .mini-checkboxlist table label,\n.panel .mini-radiobuttonlist table label,\n.panel .mini-checkbox,\n.panel .mini-checkboxlist,\n.panel .mini-radiobuttonlist,\n.panel .mini-radiobuttonlist label,\n.panel .mini-layout,\n.panel .mini-calendar,\n.panel .mini-calendar-menu-month,\n.panel mini-calendar-date,\n.panel mini-calendar-menu-year,\n.panel .mini-calendar-title {\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  font-size: 16px;\n}\n.globe .gb_form.mini-datepicker,\n.panel .gb_form.mini-datepicker {\n  width: 100%;\n  height: 32px;\n  line-height: 32px;\n}\n.globe .gb_form .mini-buttonedit-border,\n.panel .gb_form .mini-buttonedit-border {\n  height: 30px;\n  border: 1px solid #ccc;\n  border-radius: 3px;\n}\n.globe .gb_form .mini-buttonedit-border > input,\n.panel .gb_form .mini-buttonedit-border > input {\n  line-height: 30px;\n  height: 30px;\n  font-size: 16px;\n}\n.globe .gb_form .mini-buttonedit-button,\n.globe .gb_form .mini-buttonedit-close,\n.panel .gb_form .mini-buttonedit-button,\n.panel .gb_form .mini-buttonedit-close {\n  height: 26px;\n}\n.globe .gb_form.mini-buttonedit,\n.panel .gb_form.mini-buttonedit {\n  display: inline-block;\n  height: 32px;\n  width: 100%;\n  /* float: left; */\n}\n.globe .mini-grid > .mini-grid-border,\n.panel .mini-grid > .mini-grid-border {\n  border-radius: 4px 4px 4px 4px;\n}\n.globe .mini-datagrid-bar,\n.panel .mini-datagrid-bar {\n  border-top: 1px solid #ccc;\n  border-left: 1px solid #ccc;\n  border-right: 1px solid #ccc;\n  border-radius: 4px 4px 0 0;\n  width: 100%;\n  background-color: #f7f8fa;\n}\n.globe .mini-datagrid-bar + .mini-grid > .mini-grid-border,\n.panel .mini-datagrid-bar + .mini-grid > .mini-grid-border {\n  border-radius: 0 0 4px 4px;\n}\n.globe .mini-grid-headerCell,\n.panel .mini-grid-headerCell {\n  background: #f7f8fa;\n  padding: 8px 0;\n  font-weight: bold;\n  color: #666;\n}\n.globe .mini-grid-cell-inner,\n.panel .mini-grid-cell-inner {\n  padding: 8px 0;\n}\n.globe .mini-datagrid-bar .mini-grid-cell-inner,\n.panel .mini-datagrid-bar .mini-grid-cell-inner {\n  padding: 4px 2px;\n}\n.globe .mini-grid-pager,\n.panel .mini-grid-pager {\n  background: #f7f8fa;\n}\n.globe .mini-grid-headerCell,\n.panel .mini-grid-headerCell {\n  vertical-align: middle;\n}\n.globe .mini-panel-border,\n.panel .mini-panel-border {\n  border: 1px solid #ccc;\n}\n.globe .mini-grid-headerCell,\n.panel .mini-grid-headerCell {\n  border-color: #ccc;\n}\n.globe .mini-grid-cell,\n.panel .mini-grid-cell {\n  vertical-align: middle;\n}\n.globe .mini-grid-table.mini-grid-rowstable,\n.panel .mini-grid-table.mini-grid-rowstable {\n  overflow: hidden;\n}\n.globe .mini-grid-table.mini-grid-rowstable,\n.globe .mini-grid-table.mini-grid-rowstable,\n.panel .mini-grid-table.mini-grid-rowstable,\n.panel .mini-grid-table.mini-grid-rowstable {\n  overflow: visible;\n}\n.globe .mini-grid-table.mini-grid-rowstable .mini-grid-row > td:last-child,\n.globe .mini-grid-table.mini-grid-rowstable.mini-grid-row > td:last-child,\n.panel .mini-grid-table.mini-grid-rowstable .mini-grid-row > td:last-child,\n.panel .mini-grid-table.mini-grid-rowstable.mini-grid-row > td:last-child {\n  border-right-width: 0;\n}\n.globe .row,\n.panel .row {\n  line-height: 32px;\n  padding: 0 6px;\n  margin: 3px 0;\n  overflow: hidden;\n  width: 100%;\n  position: relative;\n  display: block;\n}\n.globe .row > label,\n.panel .row > label {\n  display: block;\n  text-align: right;\n}\n.globe .row > *,\n.panel .row > * {\n  overflow: hidden;\n}\n.globe .row > .col-1,\n.panel .row > .col-1 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-1,\n.panel .row > .col-1 {\n  width: 8.3333333333%;\n}\n.globe .row > .offset-1,\n.panel .row > .offset-1 {\n  margin-left: 8.3333333333%;\n}\n.globe .row > .row.col-1,\n.panel .row > .row.col-1 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-1,\n.panel .row > .mini-datepicker.col-1 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-1,\n.panel .row > .mini-datepicker.col-1 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-1,\n.panel .row > .mini-buttonedit.col-1 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-1,\n.panel .row > .mini-autocomplete.col-1 {\n  padding: 0;\n}\n.globe .row > .col-2,\n.panel .row > .col-2 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-2,\n.panel .row > .col-2 {\n  width: 16.6666666667%;\n}\n.globe .row > .offset-2,\n.panel .row > .offset-2 {\n  margin-left: 16.6666666667%;\n}\n.globe .row > .row.col-2,\n.panel .row > .row.col-2 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-2,\n.panel .row > .mini-datepicker.col-2 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-2,\n.panel .row > .mini-datepicker.col-2 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-2,\n.panel .row > .mini-buttonedit.col-2 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-2,\n.panel .row > .mini-autocomplete.col-2 {\n  padding: 0;\n}\n.globe .row > .col-3,\n.panel .row > .col-3 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-3,\n.panel .row > .col-3 {\n  width: 25%;\n}\n.globe .row > .offset-3,\n.panel .row > .offset-3 {\n  margin-left: 25%;\n}\n.globe .row > .row.col-3,\n.panel .row > .row.col-3 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-3,\n.panel .row > .mini-datepicker.col-3 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-3,\n.panel .row > .mini-datepicker.col-3 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-3,\n.panel .row > .mini-buttonedit.col-3 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-3,\n.panel .row > .mini-autocomplete.col-3 {\n  padding: 0;\n}\n.globe .row > .col-4,\n.panel .row > .col-4 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-4,\n.panel .row > .col-4 {\n  width: 33.3333333333%;\n}\n.globe .row > .offset-4,\n.panel .row > .offset-4 {\n  margin-left: 33.3333333333%;\n}\n.globe .row > .row.col-4,\n.panel .row > .row.col-4 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-4,\n.panel .row > .mini-datepicker.col-4 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-4,\n.panel .row > .mini-datepicker.col-4 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-4,\n.panel .row > .mini-buttonedit.col-4 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-4,\n.panel .row > .mini-autocomplete.col-4 {\n  padding: 0;\n}\n.globe .row > .col-5,\n.panel .row > .col-5 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-5,\n.panel .row > .col-5 {\n  width: 41.6666666667%;\n}\n.globe .row > .offset-5,\n.panel .row > .offset-5 {\n  margin-left: 41.6666666667%;\n}\n.globe .row > .row.col-5,\n.panel .row > .row.col-5 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-5,\n.panel .row > .mini-datepicker.col-5 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-5,\n.panel .row > .mini-datepicker.col-5 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-5,\n.panel .row > .mini-buttonedit.col-5 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-5,\n.panel .row > .mini-autocomplete.col-5 {\n  padding: 0;\n}\n.globe .row > .col-6,\n.panel .row > .col-6 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-6,\n.panel .row > .col-6 {\n  width: 50%;\n}\n.globe .row > .offset-6,\n.panel .row > .offset-6 {\n  margin-left: 50%;\n}\n.globe .row > .row.col-6,\n.panel .row > .row.col-6 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-6,\n.panel .row > .mini-datepicker.col-6 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-6,\n.panel .row > .mini-datepicker.col-6 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-6,\n.panel .row > .mini-buttonedit.col-6 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-6,\n.panel .row > .mini-autocomplete.col-6 {\n  padding: 0;\n}\n.globe .row > .col-7,\n.panel .row > .col-7 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-7,\n.panel .row > .col-7 {\n  width: 58.3333333333%;\n}\n.globe .row > .offset-7,\n.panel .row > .offset-7 {\n  margin-left: 58.3333333333%;\n}\n.globe .row > .row.col-7,\n.panel .row > .row.col-7 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-7,\n.panel .row > .mini-datepicker.col-7 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-7,\n.panel .row > .mini-datepicker.col-7 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-7,\n.panel .row > .mini-buttonedit.col-7 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-7,\n.panel .row > .mini-autocomplete.col-7 {\n  padding: 0;\n}\n.globe .row > .col-8,\n.panel .row > .col-8 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-8,\n.panel .row > .col-8 {\n  width: 66.6666666667%;\n}\n.globe .row > .offset-8,\n.panel .row > .offset-8 {\n  margin-left: 66.6666666667%;\n}\n.globe .row > .row.col-8,\n.panel .row > .row.col-8 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-8,\n.panel .row > .mini-datepicker.col-8 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-8,\n.panel .row > .mini-datepicker.col-8 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-8,\n.panel .row > .mini-buttonedit.col-8 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-8,\n.panel .row > .mini-autocomplete.col-8 {\n  padding: 0;\n}\n.globe .row > .col-9,\n.panel .row > .col-9 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-9,\n.panel .row > .col-9 {\n  width: 75%;\n}\n.globe .row > .offset-9,\n.panel .row > .offset-9 {\n  margin-left: 75%;\n}\n.globe .row > .row.col-9,\n.panel .row > .row.col-9 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-9,\n.panel .row > .mini-datepicker.col-9 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-9,\n.panel .row > .mini-datepicker.col-9 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-9,\n.panel .row > .mini-buttonedit.col-9 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-9,\n.panel .row > .mini-autocomplete.col-9 {\n  padding: 0;\n}\n.globe .row > .col-10,\n.panel .row > .col-10 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-10,\n.panel .row > .col-10 {\n  width: 83.3333333333%;\n}\n.globe .row > .offset-10,\n.panel .row > .offset-10 {\n  margin-left: 83.3333333333%;\n}\n.globe .row > .row.col-10,\n.panel .row > .row.col-10 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-10,\n.panel .row > .mini-datepicker.col-10 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-10,\n.panel .row > .mini-datepicker.col-10 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-10,\n.panel .row > .mini-buttonedit.col-10 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-10,\n.panel .row > .mini-autocomplete.col-10 {\n  padding: 0;\n}\n.globe .row > .col-11,\n.panel .row > .col-11 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-11,\n.panel .row > .col-11 {\n  width: 91.6666666667%;\n}\n.globe .row > .offset-11,\n.panel .row > .offset-11 {\n  margin-left: 91.6666666667%;\n}\n.globe .row > .row.col-11,\n.panel .row > .row.col-11 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-11,\n.panel .row > .mini-datepicker.col-11 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-11,\n.panel .row > .mini-datepicker.col-11 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-11,\n.panel .row > .mini-buttonedit.col-11 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-11,\n.panel .row > .mini-autocomplete.col-11 {\n  padding: 0;\n}\n.globe .row > .col-12,\n.panel .row > .col-12 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .row > .col-12,\n.panel .row > .col-12 {\n  width: 100%;\n}\n.globe .row > .offset-12,\n.panel .row > .offset-12 {\n  margin-left: 100%;\n}\n.globe .row > .row.col-12,\n.panel .row > .row.col-12 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-12,\n.panel .row > .mini-datepicker.col-12 {\n  padding: 0;\n}\n.globe .row > .mini-datepicker.col-12,\n.panel .row > .mini-datepicker.col-12 {\n  padding: 0;\n}\n.globe .row > .mini-buttonedit.col-12,\n.panel .row > .mini-buttonedit.col-12 {\n  padding: 0;\n}\n.globe .row > .mini-autocomplete.col-12,\n.panel .row > .mini-autocomplete.col-12 {\n  padding: 0;\n}\n.globe .unit_end,\n.panel .unit_end {\n  float: right;\n}\n.globe .unit,\n.panel .unit {\n  float: left;\n}\n.globe .unit, .globe .unit_end,\n.panel .unit,\n.panel .unit_end {\n  padding: 3px 6px;\n}\n.globe .unit > .col-1, .globe .unit_end > .col-1,\n.panel .unit > .col-1,\n.panel .unit_end > .col-1 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-1, .globe .unit_end > .col-1,\n.panel .unit > .col-1,\n.panel .unit_end > .col-1 {\n  width: 8.3333333333%;\n}\n.globe .unit > .offset-1, .globe .unit_end > .offset-1,\n.panel .unit > .offset-1,\n.panel .unit_end > .offset-1 {\n  margin-left: 8.3333333333%;\n}\n.globe .unit > .row.col-1, .globe .unit_end > .row.col-1,\n.panel .unit > .row.col-1,\n.panel .unit_end > .row.col-1 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-1, .globe .unit_end > .mini-datepicker.col-1,\n.panel .unit > .mini-datepicker.col-1,\n.panel .unit_end > .mini-datepicker.col-1 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-1, .globe .unit_end > .mini-datepicker.col-1,\n.panel .unit > .mini-datepicker.col-1,\n.panel .unit_end > .mini-datepicker.col-1 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-1, .globe .unit_end > .mini-buttonedit.col-1,\n.panel .unit > .mini-buttonedit.col-1,\n.panel .unit_end > .mini-buttonedit.col-1 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-1, .globe .unit_end > .mini-autocomplete.col-1,\n.panel .unit > .mini-autocomplete.col-1,\n.panel .unit_end > .mini-autocomplete.col-1 {\n  padding: 0;\n}\n.globe .unit > .col-2, .globe .unit_end > .col-2,\n.panel .unit > .col-2,\n.panel .unit_end > .col-2 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-2, .globe .unit_end > .col-2,\n.panel .unit > .col-2,\n.panel .unit_end > .col-2 {\n  width: 16.6666666667%;\n}\n.globe .unit > .offset-2, .globe .unit_end > .offset-2,\n.panel .unit > .offset-2,\n.panel .unit_end > .offset-2 {\n  margin-left: 16.6666666667%;\n}\n.globe .unit > .row.col-2, .globe .unit_end > .row.col-2,\n.panel .unit > .row.col-2,\n.panel .unit_end > .row.col-2 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-2, .globe .unit_end > .mini-datepicker.col-2,\n.panel .unit > .mini-datepicker.col-2,\n.panel .unit_end > .mini-datepicker.col-2 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-2, .globe .unit_end > .mini-datepicker.col-2,\n.panel .unit > .mini-datepicker.col-2,\n.panel .unit_end > .mini-datepicker.col-2 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-2, .globe .unit_end > .mini-buttonedit.col-2,\n.panel .unit > .mini-buttonedit.col-2,\n.panel .unit_end > .mini-buttonedit.col-2 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-2, .globe .unit_end > .mini-autocomplete.col-2,\n.panel .unit > .mini-autocomplete.col-2,\n.panel .unit_end > .mini-autocomplete.col-2 {\n  padding: 0;\n}\n.globe .unit > .col-3, .globe .unit_end > .col-3,\n.panel .unit > .col-3,\n.panel .unit_end > .col-3 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-3, .globe .unit_end > .col-3,\n.panel .unit > .col-3,\n.panel .unit_end > .col-3 {\n  width: 25%;\n}\n.globe .unit > .offset-3, .globe .unit_end > .offset-3,\n.panel .unit > .offset-3,\n.panel .unit_end > .offset-3 {\n  margin-left: 25%;\n}\n.globe .unit > .row.col-3, .globe .unit_end > .row.col-3,\n.panel .unit > .row.col-3,\n.panel .unit_end > .row.col-3 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-3, .globe .unit_end > .mini-datepicker.col-3,\n.panel .unit > .mini-datepicker.col-3,\n.panel .unit_end > .mini-datepicker.col-3 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-3, .globe .unit_end > .mini-datepicker.col-3,\n.panel .unit > .mini-datepicker.col-3,\n.panel .unit_end > .mini-datepicker.col-3 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-3, .globe .unit_end > .mini-buttonedit.col-3,\n.panel .unit > .mini-buttonedit.col-3,\n.panel .unit_end > .mini-buttonedit.col-3 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-3, .globe .unit_end > .mini-autocomplete.col-3,\n.panel .unit > .mini-autocomplete.col-3,\n.panel .unit_end > .mini-autocomplete.col-3 {\n  padding: 0;\n}\n.globe .unit > .col-4, .globe .unit_end > .col-4,\n.panel .unit > .col-4,\n.panel .unit_end > .col-4 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-4, .globe .unit_end > .col-4,\n.panel .unit > .col-4,\n.panel .unit_end > .col-4 {\n  width: 33.3333333333%;\n}\n.globe .unit > .offset-4, .globe .unit_end > .offset-4,\n.panel .unit > .offset-4,\n.panel .unit_end > .offset-4 {\n  margin-left: 33.3333333333%;\n}\n.globe .unit > .row.col-4, .globe .unit_end > .row.col-4,\n.panel .unit > .row.col-4,\n.panel .unit_end > .row.col-4 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-4, .globe .unit_end > .mini-datepicker.col-4,\n.panel .unit > .mini-datepicker.col-4,\n.panel .unit_end > .mini-datepicker.col-4 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-4, .globe .unit_end > .mini-datepicker.col-4,\n.panel .unit > .mini-datepicker.col-4,\n.panel .unit_end > .mini-datepicker.col-4 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-4, .globe .unit_end > .mini-buttonedit.col-4,\n.panel .unit > .mini-buttonedit.col-4,\n.panel .unit_end > .mini-buttonedit.col-4 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-4, .globe .unit_end > .mini-autocomplete.col-4,\n.panel .unit > .mini-autocomplete.col-4,\n.panel .unit_end > .mini-autocomplete.col-4 {\n  padding: 0;\n}\n.globe .unit > .col-5, .globe .unit_end > .col-5,\n.panel .unit > .col-5,\n.panel .unit_end > .col-5 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-5, .globe .unit_end > .col-5,\n.panel .unit > .col-5,\n.panel .unit_end > .col-5 {\n  width: 41.6666666667%;\n}\n.globe .unit > .offset-5, .globe .unit_end > .offset-5,\n.panel .unit > .offset-5,\n.panel .unit_end > .offset-5 {\n  margin-left: 41.6666666667%;\n}\n.globe .unit > .row.col-5, .globe .unit_end > .row.col-5,\n.panel .unit > .row.col-5,\n.panel .unit_end > .row.col-5 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-5, .globe .unit_end > .mini-datepicker.col-5,\n.panel .unit > .mini-datepicker.col-5,\n.panel .unit_end > .mini-datepicker.col-5 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-5, .globe .unit_end > .mini-datepicker.col-5,\n.panel .unit > .mini-datepicker.col-5,\n.panel .unit_end > .mini-datepicker.col-5 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-5, .globe .unit_end > .mini-buttonedit.col-5,\n.panel .unit > .mini-buttonedit.col-5,\n.panel .unit_end > .mini-buttonedit.col-5 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-5, .globe .unit_end > .mini-autocomplete.col-5,\n.panel .unit > .mini-autocomplete.col-5,\n.panel .unit_end > .mini-autocomplete.col-5 {\n  padding: 0;\n}\n.globe .unit > .col-6, .globe .unit_end > .col-6,\n.panel .unit > .col-6,\n.panel .unit_end > .col-6 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-6, .globe .unit_end > .col-6,\n.panel .unit > .col-6,\n.panel .unit_end > .col-6 {\n  width: 50%;\n}\n.globe .unit > .offset-6, .globe .unit_end > .offset-6,\n.panel .unit > .offset-6,\n.panel .unit_end > .offset-6 {\n  margin-left: 50%;\n}\n.globe .unit > .row.col-6, .globe .unit_end > .row.col-6,\n.panel .unit > .row.col-6,\n.panel .unit_end > .row.col-6 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-6, .globe .unit_end > .mini-datepicker.col-6,\n.panel .unit > .mini-datepicker.col-6,\n.panel .unit_end > .mini-datepicker.col-6 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-6, .globe .unit_end > .mini-datepicker.col-6,\n.panel .unit > .mini-datepicker.col-6,\n.panel .unit_end > .mini-datepicker.col-6 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-6, .globe .unit_end > .mini-buttonedit.col-6,\n.panel .unit > .mini-buttonedit.col-6,\n.panel .unit_end > .mini-buttonedit.col-6 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-6, .globe .unit_end > .mini-autocomplete.col-6,\n.panel .unit > .mini-autocomplete.col-6,\n.panel .unit_end > .mini-autocomplete.col-6 {\n  padding: 0;\n}\n.globe .unit > .col-7, .globe .unit_end > .col-7,\n.panel .unit > .col-7,\n.panel .unit_end > .col-7 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-7, .globe .unit_end > .col-7,\n.panel .unit > .col-7,\n.panel .unit_end > .col-7 {\n  width: 58.3333333333%;\n}\n.globe .unit > .offset-7, .globe .unit_end > .offset-7,\n.panel .unit > .offset-7,\n.panel .unit_end > .offset-7 {\n  margin-left: 58.3333333333%;\n}\n.globe .unit > .row.col-7, .globe .unit_end > .row.col-7,\n.panel .unit > .row.col-7,\n.panel .unit_end > .row.col-7 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-7, .globe .unit_end > .mini-datepicker.col-7,\n.panel .unit > .mini-datepicker.col-7,\n.panel .unit_end > .mini-datepicker.col-7 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-7, .globe .unit_end > .mini-datepicker.col-7,\n.panel .unit > .mini-datepicker.col-7,\n.panel .unit_end > .mini-datepicker.col-7 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-7, .globe .unit_end > .mini-buttonedit.col-7,\n.panel .unit > .mini-buttonedit.col-7,\n.panel .unit_end > .mini-buttonedit.col-7 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-7, .globe .unit_end > .mini-autocomplete.col-7,\n.panel .unit > .mini-autocomplete.col-7,\n.panel .unit_end > .mini-autocomplete.col-7 {\n  padding: 0;\n}\n.globe .unit > .col-8, .globe .unit_end > .col-8,\n.panel .unit > .col-8,\n.panel .unit_end > .col-8 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-8, .globe .unit_end > .col-8,\n.panel .unit > .col-8,\n.panel .unit_end > .col-8 {\n  width: 66.6666666667%;\n}\n.globe .unit > .offset-8, .globe .unit_end > .offset-8,\n.panel .unit > .offset-8,\n.panel .unit_end > .offset-8 {\n  margin-left: 66.6666666667%;\n}\n.globe .unit > .row.col-8, .globe .unit_end > .row.col-8,\n.panel .unit > .row.col-8,\n.panel .unit_end > .row.col-8 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-8, .globe .unit_end > .mini-datepicker.col-8,\n.panel .unit > .mini-datepicker.col-8,\n.panel .unit_end > .mini-datepicker.col-8 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-8, .globe .unit_end > .mini-datepicker.col-8,\n.panel .unit > .mini-datepicker.col-8,\n.panel .unit_end > .mini-datepicker.col-8 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-8, .globe .unit_end > .mini-buttonedit.col-8,\n.panel .unit > .mini-buttonedit.col-8,\n.panel .unit_end > .mini-buttonedit.col-8 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-8, .globe .unit_end > .mini-autocomplete.col-8,\n.panel .unit > .mini-autocomplete.col-8,\n.panel .unit_end > .mini-autocomplete.col-8 {\n  padding: 0;\n}\n.globe .unit > .col-9, .globe .unit_end > .col-9,\n.panel .unit > .col-9,\n.panel .unit_end > .col-9 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-9, .globe .unit_end > .col-9,\n.panel .unit > .col-9,\n.panel .unit_end > .col-9 {\n  width: 75%;\n}\n.globe .unit > .offset-9, .globe .unit_end > .offset-9,\n.panel .unit > .offset-9,\n.panel .unit_end > .offset-9 {\n  margin-left: 75%;\n}\n.globe .unit > .row.col-9, .globe .unit_end > .row.col-9,\n.panel .unit > .row.col-9,\n.panel .unit_end > .row.col-9 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-9, .globe .unit_end > .mini-datepicker.col-9,\n.panel .unit > .mini-datepicker.col-9,\n.panel .unit_end > .mini-datepicker.col-9 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-9, .globe .unit_end > .mini-datepicker.col-9,\n.panel .unit > .mini-datepicker.col-9,\n.panel .unit_end > .mini-datepicker.col-9 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-9, .globe .unit_end > .mini-buttonedit.col-9,\n.panel .unit > .mini-buttonedit.col-9,\n.panel .unit_end > .mini-buttonedit.col-9 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-9, .globe .unit_end > .mini-autocomplete.col-9,\n.panel .unit > .mini-autocomplete.col-9,\n.panel .unit_end > .mini-autocomplete.col-9 {\n  padding: 0;\n}\n.globe .unit > .col-10, .globe .unit_end > .col-10,\n.panel .unit > .col-10,\n.panel .unit_end > .col-10 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-10, .globe .unit_end > .col-10,\n.panel .unit > .col-10,\n.panel .unit_end > .col-10 {\n  width: 83.3333333333%;\n}\n.globe .unit > .offset-10, .globe .unit_end > .offset-10,\n.panel .unit > .offset-10,\n.panel .unit_end > .offset-10 {\n  margin-left: 83.3333333333%;\n}\n.globe .unit > .row.col-10, .globe .unit_end > .row.col-10,\n.panel .unit > .row.col-10,\n.panel .unit_end > .row.col-10 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-10, .globe .unit_end > .mini-datepicker.col-10,\n.panel .unit > .mini-datepicker.col-10,\n.panel .unit_end > .mini-datepicker.col-10 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-10, .globe .unit_end > .mini-datepicker.col-10,\n.panel .unit > .mini-datepicker.col-10,\n.panel .unit_end > .mini-datepicker.col-10 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-10, .globe .unit_end > .mini-buttonedit.col-10,\n.panel .unit > .mini-buttonedit.col-10,\n.panel .unit_end > .mini-buttonedit.col-10 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-10, .globe .unit_end > .mini-autocomplete.col-10,\n.panel .unit > .mini-autocomplete.col-10,\n.panel .unit_end > .mini-autocomplete.col-10 {\n  padding: 0;\n}\n.globe .unit > .col-11, .globe .unit_end > .col-11,\n.panel .unit > .col-11,\n.panel .unit_end > .col-11 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-11, .globe .unit_end > .col-11,\n.panel .unit > .col-11,\n.panel .unit_end > .col-11 {\n  width: 91.6666666667%;\n}\n.globe .unit > .offset-11, .globe .unit_end > .offset-11,\n.panel .unit > .offset-11,\n.panel .unit_end > .offset-11 {\n  margin-left: 91.6666666667%;\n}\n.globe .unit > .row.col-11, .globe .unit_end > .row.col-11,\n.panel .unit > .row.col-11,\n.panel .unit_end > .row.col-11 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-11, .globe .unit_end > .mini-datepicker.col-11,\n.panel .unit > .mini-datepicker.col-11,\n.panel .unit_end > .mini-datepicker.col-11 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-11, .globe .unit_end > .mini-datepicker.col-11,\n.panel .unit > .mini-datepicker.col-11,\n.panel .unit_end > .mini-datepicker.col-11 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-11, .globe .unit_end > .mini-buttonedit.col-11,\n.panel .unit > .mini-buttonedit.col-11,\n.panel .unit_end > .mini-buttonedit.col-11 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-11, .globe .unit_end > .mini-autocomplete.col-11,\n.panel .unit > .mini-autocomplete.col-11,\n.panel .unit_end > .mini-autocomplete.col-11 {\n  padding: 0;\n}\n.globe .unit > .col-12, .globe .unit_end > .col-12,\n.panel .unit > .col-12,\n.panel .unit_end > .col-12 {\n  line-height: 32px;\n  padding: 0px 6px;\n  margin: 3px 0;\n  float: left;\n  position: relative;\n}\n.globe .unit > .col-12, .globe .unit_end > .col-12,\n.panel .unit > .col-12,\n.panel .unit_end > .col-12 {\n  width: 100%;\n}\n.globe .unit > .offset-12, .globe .unit_end > .offset-12,\n.panel .unit > .offset-12,\n.panel .unit_end > .offset-12 {\n  margin-left: 100%;\n}\n.globe .unit > .row.col-12, .globe .unit_end > .row.col-12,\n.panel .unit > .row.col-12,\n.panel .unit_end > .row.col-12 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-12, .globe .unit_end > .mini-datepicker.col-12,\n.panel .unit > .mini-datepicker.col-12,\n.panel .unit_end > .mini-datepicker.col-12 {\n  padding: 0;\n}\n.globe .unit > .mini-datepicker.col-12, .globe .unit_end > .mini-datepicker.col-12,\n.panel .unit > .mini-datepicker.col-12,\n.panel .unit_end > .mini-datepicker.col-12 {\n  padding: 0;\n}\n.globe .unit > .mini-buttonedit.col-12, .globe .unit_end > .mini-buttonedit.col-12,\n.panel .unit > .mini-buttonedit.col-12,\n.panel .unit_end > .mini-buttonedit.col-12 {\n  padding: 0;\n}\n.globe .unit > .mini-autocomplete.col-12, .globe .unit_end > .mini-autocomplete.col-12,\n.panel .unit > .mini-autocomplete.col-12,\n.panel .unit_end > .mini-autocomplete.col-12 {\n  padding: 0;\n}\n.globe .list_table,\n.panel .list_table {\n  table-layout: fixed;\n  width: 100%;\n  border-top: 1px solid #e0e0e0;\n  border-left: 1px solid #e0e0e0;\n  /* margin-left: -1px; */\n}\n.globe .list_table td,\n.globe .list_table th,\n.panel .list_table td,\n.panel .list_table th {\n  border-right: 1px solid #ededed;\n  border-bottom: 1px solid #ededed;\n  vertical-align: middle;\n}\n.globe .list_table .control_width,\n.panel .list_table .control_width {\n  height: 0;\n}\n.globe .list_table .control_width td,\n.panel .list_table .control_width td {\n  border-width: 0 !important;\n  padding: 0 !important;\n}\n.globe .list_table tr.name td,\n.panel .list_table tr.name td {\n  text-align: left;\n  padding-left: 60px !important;\n  font-size: 16px;\n  font-weight: bold;\n  padding: 8px 0;\n  line-height: 18px;\n}\n.globe .list_table td.list_table-title,\n.globe .list_table th,\n.panel .list_table td.list_table-title,\n.panel .list_table th {\n  background-color: #f7f8fa;\n  text-align: center;\n  padding: 8px 0;\n  line-height: 18px;\n}\n.globe .list_table td.list_table-content,\n.globe .list_table td,\n.panel .list_table td.list_table-content,\n.panel .list_table td {\n  padding: 3px;\n}\n.globe .list_table td.list_table-content > .row,\n.globe .list_table td > .row,\n.panel .list_table td.list_table-content > .row,\n.panel .list_table td > .row {\n  padding: 3px 0;\n}\n.globe .btn_group,\n.panel .btn_group {\n  overflow: hidden;\n}\n.globe .btn_group.right,\n.panel .btn_group.right {\n  float: right;\n}\n.globe .btn_group.center,\n.panel .btn_group.center {\n  width: 100%;\n  text-align: center;\n}\n.globe .btn_group.center > .block_btn,\n.panel .btn_group.center > .block_btn {\n  float: none;\n}\n.globe .btn_group.left,\n.panel .btn_group.left {\n  float: left;\n}\n.globe .btn_group > a.block_btn,\n.panel .btn_group > a.block_btn {\n  margin: 2px 0 2px 8px;\n  float: left;\n}\n.globe .row .btn_group > a.block_btn,\n.panel .row .btn_group > a.block_btn {\n  margin: 3px 0 3px 8px;\n}\n.globe a.block_btn,\n.panel a.block_btn {\n  vertical-align: top;\n  display: inline-block;\n  height: 32px;\n  background-color: #0b70c1;\n  border: 1px solid #0b70c1;\n  line-height: 30px;\n  color: #fff;\n  padding: 0 8px;\n  margin: 3px 0 3px 8px;\n  border-radius: 3px;\n  cursor: pointer;\n  text-align: center;\n  transition: all 0.3 ease-out;\n}\n.globe a.inline_btn,\n.panel a.inline_btn {\n  margin: 3px 0 3px 8px;\n  display: inline-block;\n  color: #3876b9;\n  margin: 0 4px;\n  padding: 0 3px;\n  cursor: pointer;\n  position: relative;\n}\n.globe a.inline_btn:hover,\n.panel a.inline_btn:hover {\n  text-decoration: underline;\n}\n.globe a.block_btn.white,\n.panel a.block_btn.white {\n  background-color: #fff;\n  color: #0b70c1;\n}\n.globe a.block_btn.disabled,\n.panel a.block_btn.disabled {\n  background-color: #999;\n  border-color: #999;\n  cursor: not-allowed;\n}\n.globe a.block_btn:hover,\n.panel a.block_btn:hover {\n  opacity: 0.9;\n}\n.globe form.common,\n.globe form.mini,\n.panel form.common,\n.panel form.mini {\n  width: 900px;\n  margin: 0 auto;\n  padding: 12px 0 12px 0;\n}\n.globe form.common.mini,\n.globe form.mini.mini,\n.panel form.common.mini,\n.panel form.mini.mini {\n  padding: 0;\n}\n.globe form.common.mini legend:first-child,\n.globe form.mini.mini legend:first-child,\n.panel form.common.mini legend:first-child,\n.panel form.mini.mini legend:first-child {\n  margin: 0 0 24px 0;\n}\n.globe form.common.mini legend,\n.globe form.mini.mini legend,\n.panel form.common.mini legend,\n.panel form.mini.mini legend {\n  margin: 0 0 36px 0;\n  color: #0a5897;\n  background: #fff;\n  border-bottom: 2px solid #0a5897;\n}\n.globe form.common.mini legend::before,\n.globe form.mini.mini legend::before,\n.panel form.common.mini legend::before,\n.panel form.mini.mini legend::before {\n  display: none;\n}\n.globe form.common.mini > fieldset,\n.globe form.mini.mini > fieldset,\n.panel form.common.mini > fieldset,\n.panel form.mini.mini > fieldset {\n  margin: 0 0 16px 0;\n}\n.globe form.common > fieldset,\n.globe form.mini > fieldset,\n.panel form.common > fieldset,\n.panel form.mini > fieldset {\n  margin: 16px 0;\n  position: relative;\n  width: 100%;\n  display: block;\n  overflow: hidden;\n  min-width: auto;\n}\n.globe form.common > fieldset .row,\n.globe form.mini > fieldset .row,\n.panel form.common > fieldset .row,\n.panel form.mini > fieldset .row {\n  height: auto;\n}\n.globe form.common legend,\n.globe form.mini legend,\n.panel form.common legend,\n.panel form.mini legend {\n  line-height: 24px;\n  padding: 6px;\n  margin: 16px 0;\n  font-size: 16px;\n  font-weight: bold;\n  color: #666;\n  padding-left: 16px;\n  position: relative;\n  background-color: #eff5fa;\n  width: 100%;\n}\n.globe form.common legend:before,\n.globe form.mini legend:before,\n.panel form.common legend:before,\n.panel form.mini legend:before {\n  position: absolute;\n  top: 0;\n  left: 0;\n  height: 100%;\n  width: 6px;\n  background-color: #0a5897;\n  content: \"\";\n}\n.globe input.gb_form,\n.globe select.gb_form,\n.panel input.gb_form,\n.panel select.gb_form {\n  vertical-align: top;\n  height: 32px;\n  min-width: 100px;\n  display: inline-block;\n  line-height: 30px;\n  padding: 0 0 0 6px;\n  border-radius: 3px;\n  border: 1px solid #ccc;\n  outline: none;\n  font-size: 16px;\n  background-color: #fff;\n}\n.globe label.gb_form,\n.panel label.gb_form {\n  vertical-align: top;\n  display: inline-block;\n  padding: 0 3px 0 6px;\n  line-height: 32px;\n  height: 32px;\n}\n.globe input.gb_form:focus,\n.globe select.gb_form:focus,\n.globe textarea.gb_form:focus,\n.panel input.gb_form:focus,\n.panel select.gb_form:focus,\n.panel textarea.gb_form:focus {\n  border-color: #808891;\n}\n.globe input.gb_form:disabled,\n.globe select.gb_form:disabled,\n.globe textarea.gb_form:disabled,\n.panel input.gb_form:disabled,\n.panel select.gb_form:disabled,\n.panel textarea.gb_form:disabled {\n  background-color: #ebebe4;\n}\n.globe .col-1 > input.gb_form,\n.globe .col-1 > select.gb_form,\n.globe .col-1 > textarea.gb_form,\n.panel .col-1 > input.gb_form,\n.panel .col-1 > select.gb_form,\n.panel .col-1 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-2 > input.gb_form,\n.globe .col-2 > select.gb_form,\n.globe .col-2 > textarea.gb_form,\n.panel .col-2 > input.gb_form,\n.panel .col-2 > select.gb_form,\n.panel .col-2 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-3 > input.gb_form,\n.globe .col-3 > select.gb_form,\n.globe .col-3 > textarea.gb_form,\n.panel .col-3 > input.gb_form,\n.panel .col-3 > select.gb_form,\n.panel .col-3 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-4 > input.gb_form,\n.globe .col-4 > select.gb_form,\n.globe .col-4 > textarea.gb_form,\n.panel .col-4 > input.gb_form,\n.panel .col-4 > select.gb_form,\n.panel .col-4 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-5 > input.gb_form,\n.globe .col-5 > select.gb_form,\n.globe .col-5 > textarea.gb_form,\n.panel .col-5 > input.gb_form,\n.panel .col-5 > select.gb_form,\n.panel .col-5 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-6 > input.gb_form,\n.globe .col-6 > select.gb_form,\n.globe .col-6 > textarea.gb_form,\n.panel .col-6 > input.gb_form,\n.panel .col-6 > select.gb_form,\n.panel .col-6 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-7 > input.gb_form,\n.globe .col-7 > select.gb_form,\n.globe .col-7 > textarea.gb_form,\n.panel .col-7 > input.gb_form,\n.panel .col-7 > select.gb_form,\n.panel .col-7 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-8 > input.gb_form,\n.globe .col-8 > select.gb_form,\n.globe .col-8 > textarea.gb_form,\n.panel .col-8 > input.gb_form,\n.panel .col-8 > select.gb_form,\n.panel .col-8 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-9 > input.gb_form,\n.globe .col-9 > select.gb_form,\n.globe .col-9 > textarea.gb_form,\n.panel .col-9 > input.gb_form,\n.panel .col-9 > select.gb_form,\n.panel .col-9 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-10 > input.gb_form,\n.globe .col-10 > select.gb_form,\n.globe .col-10 > textarea.gb_form,\n.panel .col-10 > input.gb_form,\n.panel .col-10 > select.gb_form,\n.panel .col-10 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-11 > input.gb_form,\n.globe .col-11 > select.gb_form,\n.globe .col-11 > textarea.gb_form,\n.panel .col-11 > input.gb_form,\n.panel .col-11 > select.gb_form,\n.panel .col-11 > textarea.gb_form {\n  width: 100%;\n}\n.globe .col-12 > input.gb_form,\n.globe .col-12 > select.gb_form,\n.globe .col-12 > textarea.gb_form,\n.panel .col-12 > input.gb_form,\n.panel .col-12 > select.gb_form,\n.panel .col-12 > textarea.gb_form {\n  width: 100%;\n}\n.globe label,\n.panel label {\n  white-space: nowrap;\n  word-wrap: normal;\n  word-break: keep-all;\n  text-align: right;\n  padding: 0 6px;\n}\n.globe textarea.gb_form,\n.panel textarea.gb_form {\n  width: 100%;\n  line-height: 18px;\n  padding: 4px 8px;\n  resize: none;\n  height: 100%;\n  min-height: 72px;\n  border-radius: 3px;\n  border: 1px solid #ccc;\n}\n.globe textarea.gb_form:focus,\n.panel textarea.gb_form:focus {\n  border-color: #808891;\n}\n.globe .required:after,\n.panel .required:after {\n  content: \"*\";\n  color: red;\n}\n.globe .icon-add,\n.panel .icon-add {\n  background: none;\n}\n.globe .flex-row,\n.panel .flex-row {\n  display: flex;\n  flex-direction: row;\n}\n.globe .flex-col,\n.panel .flex-col {\n  display: flex;\n  flex-direction: column;\n}";
  styleInject(css);
  ...
  ***************************************************************************** */
  ...
  var Date$1 = /** @class */ (function (_super) {
      __extends(Date, _super);
      function Date(id, config) {
          var _this = _super.call(this, id, Object.assign({}, Date.config, config)) || this;
          _this.target = null;
          _this.uid = Math.floor(Math.random() * 10000).toString();
          _this.reflashView();
          return _this;
      }
      Date.gen = function (s, config) {
          return new this(s, config);
      };
      Date.prototype.reflashView = function () {
          var _this = this;
      ...
      Date.prototype.setValue = function (v) {
          var c = v || '';
          this.value = c;
  ...
  var Radio = /** @class */ (function (_super) {
      ...
      function Radio(id, config) {
          var _this = _super.call(this, id, Object.assign({}, Radio.config, config)) || this;
          _this.list = [];
          _this.target = [];
          _this.uid = Math.floor(Math.random() * 10000).toString();
          _this.reflashView();
      ...
      Radio.prototype.reflashView = function () {
          ...
          this.target = this.list.map(function (v) {
              ...
              r.disabled = _this.config.readonly;
              r.value = v.value;
              s.innerHTML = v.text;
  ...
  var Select = /** @class */ (function (_super) {
      ...
      function Select(id, config) {
          var _this = _super.call(this, id, Object.assign({}, Select.config, config)) || this;
          _this.list = [];
  ...
  var Text = /** @class */ (function (_super) {
      ...
      function Text(id, config) {
          var _this = _super.call(this, id, Object.assign({}, Text.config, config)) || this;
  ...
  var checkbox = /** @class */ (function (_super) {
      ...
      function checkbox(id, config) {
          var _this = _super.call(this, id, Object.assign({}, checkbox.config, config)) || this;
          _this.list = [];
          _this.target = [];
          _this.uid = Math.floor(Math.random() * 10000).toString();
          _this.reflashView();
  ...
  var DetailSelect = /** @class */ (function (_super) {
      ...
      function DetailSelect(id, tableName, config) {
          var _this = _super.call(this, id, Object.assign({}, DetailSelect.config, config)) || this;
          _this.list = [];
          _this.target = null;
  ...
  var AutoComplete = /** @class */ (function (_super) {
      ...
      function AutoComplete(id, config) {
          var _this = _super.call(this, id, Object.assign({}, AutoComplete.config, config)) || this;
          _this.target = null;
          _this.uid = Math.floor(Math.random() * 10000).toString();
          _this.reflashView();
          return _this;
      }
      AutoComplete.gen = function (s, config) {
          return new this(s, config);
      };
      AutoComplete.prototype.reflashView = function () {
          var _this = this;
          var id = 'mymini-' + this.id + this.uid;
          console.log(id);
          var temp = document.createElement('input');
          ...
          this.target.onValueChanged(this.config.onchange || (function (c) {
              if (c.selected) {
                  _this.setValue([
                      c.selected['id'],
                      c.selected['text'],
  ...
  function Scope(c) {
      ...
      return {
          ...
          run: function (name) {
              ...
              if (map[name]) {
                  return (_a = map[name]).call.apply(_a, __spreadArrays([null], [set].concat(arg)));
              }
          }
      };
  }
